...
//     获取所有的title信息，title的信息来自a标签的文本信息
    ...
    for (var i = 0 ; i < developTools.length ; i++){
    var li = document.createElement("li")
    li.innerHTML = "<center><img src='"+developTools[i].img+"' alt=''><br><a href='" + developTools[i].titleLink + "' , target='_blank' class='title'>" + developTools[i].title + "<p>" + developTools[i].description + "</p></a></center>"
    document.getElementById("developTools").appendChild(li)
}
    ...
    for (var i = 0 ; i < systemDownload.length ; i++){
    var li = document.createElement("li")
    li.innerHTML = "<center><img src='"+systemDownload[i].img+"' alt=''><br><a href='" + systemDownload[i].titleLink + "' , target='_blank' class='title'>" + systemDownload[i].title + "<p>" + systemDownload[i].description + "</p></a></center>"
    document.getElementById("systemDownload").appendChild(li)
}