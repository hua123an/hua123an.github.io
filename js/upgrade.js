    ...
    for (var i = 0; i < advancedMath.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<a href='" + advancedMath[i].titleLink + "' target='iframe'><span>" + advancedMath[i].part + "</span>&nbsp<b>" + advancedMath[i].title + "</b>&nbsp" + advancedMath[i].time + "</a>"
    document.getElementById("list").appendChild(li)
    document.getElementById("iframe").playbackRate = 16
}
    <!--当网页加载时，清楚上一次点击的a标签的点击事件，将颜色变为默认颜色-->
    ...
    // 给a标签设置点击事件，点击时，将a标签的颜色变为红色,并且将其他a标签的颜色变为默认颜色
    document.getElementById("list").onclick = function (e) {
    var li = document.getElementsByTagName("li")
    for (var i = 0; i < li.length; i++) {
    li[i].style.color = "aqua"
}
