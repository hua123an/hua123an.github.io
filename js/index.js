...
const choseColors = [
    ...
    },
    {
        ...
        "img": "/img/colormind.png",
        "description": "基于AI的调色网站，可以生成配色方案。"
    },
    {
        "title": "khroma",
        "titleLink": "https://khroma.co/",
        "img": "https://www.khroma.co/assets/images/wordmark.svg",
...
for (var i = 0; i < choseColors.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><a href='" + choseColors[i].titleLink + "' target='_blank' class='title'><img src='" + choseColors[i].img + "' alt=''><br>" + choseColors[i].title + "<p>" + choseColors[i].description + "</p></a></center>"
    document.getElementById("choseColor").appendChild(li)
}
...
for (var i = 0; i < commonTools.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><a href='" + commonTools[i].titleLink + "' target='_blank' class='title'><img src='" + commonTools[i].img + "' alt=''><br>" + commonTools[i].title + "</a></center>"
    document.getElementById("commonTools").appendChild(li);
}
const compileTools = [{
    "title": "\n\t\t\t\t\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t\t\t\t\t\t\n\n\n\t\t\t\t\t\t\t\t\t\t\t\tPHP 在线工具 \n\t\t\t\t\t\t\t\t\t\t",
...
for (var i = 0; i < compileTools.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><a href='" + commonTools[i].titleLink + "' target='_blank' class='title'><img src='" + compileTools[i].img + "' alt=''><br>" + compileTools[i].title + "</a></center>"
    document.getElementById("compileTools").appendChild(li);
}
...
for (var i = 0; i < technologyLearning.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><img src='" + technologyLearning[i].img + "' alt=''><a href='" + technologyLearning[i].titleLink + "' , target='_blank' class='title'>" + technologyLearning[i].title + "<p>" + technologyLearning[i].description + "</p></a></center>"
    document.getElementById("technologyLearning").appendChild(li)
}
...
for (var i = 0; i < developSoftware.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><img src='" + developSoftware[i].img + "' alt=''><a href='" + developSoftware[i].titleLink + "' , target='_blank' class='title'>" + developSoftware[i].title + "<p>" + developSoftware[i].description + "</p></a></center>"
    document.getElementById("developSoftware").appendChild(li)
}
const publicIcon = [{
    "title": "\n\t\t\t\t\t\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t\t\t\t\t\tStaticfile CDN",
...
for (var i = 0; i < publicIcon.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center><img src='" + publicIcon[i].img + "' alt=''><a href='" + publicIcon[i].titleLink + "' , target='_blank' class='title'>" + publicIcon[i].title + "<p>" + publicIcon[i].description + "</p></a></center>"
    document.getElementById("publicIcon").appendChild(li)
}
const onlineTools = [{
    "title": "\n\t\t\t\t\t\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t\t\t\t\t\tRegExr",
...
for (var i = 0; i < onlineTools.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><img src='" + onlineTools[i].img + "' alt=''><a href='" + onlineTools[i].titleLink + "' , target='_blank' class='title'>" + onlineTools[i].title + "<p>" + onlineTools[i].description + "</p></a></center>"
    document.getElementById("onlineTools").appendChild(li)
}
const codeManager = [{
    "title": "\n\t\t\t\t\t\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t\t\t\t\t\tGitHub",
...
for (var i = 0; i < codeManager.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><img src='" + codeManager[i].img + "' alt=''><a href='" + codeManager[i].titleLink + "' , target='_blank' class='title'>" + codeManager[i].title + "<p>" + codeManager[i].description + "</p></a></center>"
    document.getElementById("codeManager").appendChild(li)
}
const searchEngine = [{
    "title": " \n            Google        ",
...
for (var i = 0; i < searchEngine.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center><img src='" + searchEngine[i].img + "' alt=''><a href='" + searchEngine[i].titleLink + "' , target='_blank' class='title'>" + searchEngine[i].title + "<p>" + searchEngine[i].description + "</p></a></center>"
    document.getElementById("searchEngine").appendChild(li);
}