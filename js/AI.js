    ...
    *1.获取输入框的值
    * 2.获取所有的标题
    * 3.遍历所有的标题，判断标题中是否包含输入框的值，标题信息存在于img的alt属性中
    * 4.如果包含，就高亮显示，然后定位到标题所在的位置
    * */
    ...
    // 4.如果包含，就高亮显示，然后定位到标题所在的位置
    data = titles[i].alt;
    //     判断两者的值,在data中就算是只存在一个字符串和输入值相符，定位到该元素,并且判断是不区分大小写
    if (data.toLowerCase().indexOf(searchValue.toLowerCase()) != -1) {
    //     获取标题所在的位置
    ...
    for (var i = 0; i < aiApplication.length; i++) {
    data = aiApplication[i]
    var li = document.createElement("li")
    li.innerHTML = "<center>" + "<a href='" + data.titleLink + "' target='_blank'><img src='" + data.img + "' alt='" + data.title + "'><h3>" + data.title + "</h3><p>" + data.description + "</p></a>\n" + "</center>"
    document.getElementById("aiAPP").appendChild(li)
}
    const aiProgramming = [{
    "title": " \n            autobackend        ",
    "titleLink": "https://www.autobackend.dev/",
    ...
    for (var i = 0; i < aiProgramming.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center>"+"<a href='" + aiProgramming[i].titleLink + "' target='_blank'><img src='" + aiProgramming[i].img + "' alt='" + aiProgramming[i].title + "'><h3>" + aiProgramming[i].title + "</h3><p>" + aiProgramming[i].description + "</p></a>\n" + "</center>";
    document.getElementById("aiProgramming").appendChild(li);
}
    const aiWrite = [{
    "title": " \n            FlowUs        ",
    ...
    for (var i = 0; i < aiWrite.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center>"+"<a href='" + aiWrite[i].titleLink + "' target='_blank'><img src='" + aiWrite[i].img + "' alt='" + aiWrite[i].title + "'><h3>" + aiWrite[i].title + "</h3><p>" + aiWrite[i].description + "</p></a>\n" + "</center>";
    document.getElementById("aiWrite").appendChild(li);
}
    const aiDesign = [{
    "title": " \n            Adobe Firefly        ",
    ...
    for (var i = 0; i < aiDesign.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center>"+"<a href='" + aiDesign[i].titleLink + "' target='_blank'><img src='" + aiDesign[i].img + "' alt='" + aiDesign[i].title + "'><h3>" + aiDesign[i].title + "</h3><p>" + aiDesign[i].description + "</p></a>\n" + "</center>";
    document.getElementById("aiDesign").appendChild(li);
}
    const aiDrawing = [{
    "title": " \n            PicWish        ",
    ...
    for (var i = 0; i < aiDrawing.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center>"+"<a href='" + aiDrawing[i].titleLink + "' target='_blank'><img src='" + aiDrawing[i].img + "' alt='" + aiDrawing[i].title + "'><h3>" + aiDrawing[i].title + "</h3><p>" + aiDrawing[i].description + "</p></a>\n" + "</center>";
    document.getElementById("aiDrawing").appendChild(li);
}
    const aiModel = [{
    "title": " \n            Codex        ",
    "img": "https://tools.haiyong.site/wp-content/uploads/2023/06/qmruasgh98rw6a4u4yop.webp",
    ...
    for (var i = 0; i < aiModel.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center>"+"<a href='" + aiModel[i].titleLink + "' target='_blank'><img src='" + aiModel[i].img + "' alt='" + aiModel[i].title + "'><h3>" + aiModel[i].title + "</h3><p>" + aiModel[i].description + "</p></a>\n" + "</center>";
    document.getElementById("aiModel").appendChild(li);
}
    const aiAudio = [{
    "title": " \n            Runway        ",
    "img": "https://tools.haiyong.site/wp-content/uploads/2023/02/runway.png",
    ...
    for (var i = 0; i < aiAudio.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center>"+"<a href='" + aiAudio[i].titleLink + "' target='_blank'><img src='" + aiAudio[i].img + "' alt='" + aiAudio[i].title + "'><h3>" + aiAudio[i].title + "</h3><p>" + aiAudio[i].description + "</p></a>\n" + "</center>";
    document.getElementById("aiAudio").appendChild(li);
}
    const aiWorking = [{
    "title": " \n            Tome AI        ",
    "img": "https://tools.haiyong.site/wp-content/uploads/2023/02/TOME.png",
    ...
    for (var i = 0; i < aiWorking.length; i++) {
    var li = document.createElement("li");
    li.innerHTML = "<center>"+"<a href='" + aiWorking[i].titleLink + "' target='_blank'><img src='" + aiWorking[i].img + "' alt='" + aiWorking[i].title + "'><h3>" + aiWorking[i].title + "</h3><p>" + aiWorking[i].description + "</p></a>\n" + "</center>";
    document.getElementById("aiWorking").appendChild(li);
}