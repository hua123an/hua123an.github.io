...
const academicSearch = [
    {
        "title" : "pubscholar",
        "titleLink" : "https://www.pubscholar.cn",
        "img" : "https://pubscholar.cn/static/app-logo-cas.png",
        "description" : "中科院出品"
    },
    {
        "title" : "四川省图书馆",
        "titleLink" : "https://www.sclib.org/",
        "img" : "https://www.sclib.org/images/lib/logo.png",
        "description" : "四川省图书馆"
    },
    {
        "title" : "陕西省图书馆" ,
        "titleLink" : "https://www.sxlib.org.cn/",
        "img" : "https://www.sxlib.org.cn/images/home-logo.png",
        "description" : "陕西省图书馆"
    }
    ,{
    "title": " \n            SimilarWeb        ",
...
for (var i = 0; i < academicSearch.length; i++) {
    var li = document.createElement("li")
    li.innerHTML = "<center><img src='" + academicSearch[i].img + "' alt=''><br><a href='" + academicSearch[i].titleLink + "' , target='_blank' class='title'>" + academicSearch[i].title + "<p>" + academicSearch[i].description + "</p></a></center>"
    document.getElementById("academicSearch").appendChild(li)
